...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JameJafari.Core.Entities.MessengerMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("RemoteMessageIds")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("DeletedFromRemote")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("JameJafari.Core.Entities.CostTransaction", b =>
                {
                    ...
                    b.HasIndex("CostTypeId", "TransactionDate");
            ...
            modelBuilder.Entity("JameJafari.Core.Entities.GeneralType", b =>
                {
                    ...
                    b.HasIndex("Category", "IsDeleted", "SortOrder");
            ...
            modelBuilder.Entity("JameJafari.Core.Entities.RubikaBotState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("KnownGroupChatsJson")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("LastOffsetId")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("JameJafari.Core.Entities.UserPermission", b =>
                {
            ...
            modelBuilder.Entity("JameJafari.Core.Entities.Person", b =>
                {
                    ...
                    b.HasOne("JameJafari.Core.Entities.GeneralType", "NamePrefix")
                        .WithMany()
