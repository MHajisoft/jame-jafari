...
- **نمایش نمادین جداول:** در تنظیمات — «فقط آیکون» (پیش‌فرض)، «آیکون و متن»، یا «فقط متن»؛ در حالت فقط‌آیکون، ستون‌های پیام‌رسان/نوع/وضعیت مرکز پیام در یک ستون «مشخصات» جمع می‌شوند؛ در حالت‌های متنی جدا می‌مانند
...
| متغیر | توضیح |
|--------|--------|
| `BALE_BOT_TOKEN` | توکن بازوی بله (از @botfather در بله) — **هرگز commit نکنید** |
...
| `BALE_BOT_USERNAME` | نام کاربری بازوی بله (بدون @) — برای لینک شروع گفتگو |
